...
import xtrem.download.mobile.databinding.ActivityBrowserBottomAppBarBinding;
import xtrem.download.mobile.databinding.ActivityBrowserTopAppBarBinding;
import xtrem.download.mobile.ui.FragmentCallback;
import xtrem.download.mobile.ui.SendTextToClipboard;
import xtrem.download.mobile.ui.adddownload.AddDownloadActivity;
import xtrem.download.mobile.ui.adddownload.AddInitParams;
import xtrem.download.mobile.ui.browser.bookmarks.BrowserBookmarksActivity;
import xtrem.download.mobile.ui.browser.bookmarks.EditBookmarkActivity;
