...
import xtrem.download.mobile.core.exception.FreeSpaceException;
import xtrem.download.mobile.core.exception.HttpException;
import xtrem.download.mobile.core.exception.NormalizeUrlException;
import xtrem.download.mobile.core.model.data.entity.UserAgent;
import xtrem.download.mobile.core.system.FileSystemContracts;
import xtrem.download.mobile.core.utils.Utils;
import xtrem.download.mobile.databinding.DialogAddDownloadBinding;
import xtrem.download.mobile.ui.BaseAlertDialog;
import xtrem.download.mobile.ui.ClipboardDialog;
