...
import xtrem.download.mobile.core.model.ChangeableParams;
import xtrem.download.mobile.core.model.DownloadEngine;
import xtrem.download.mobile.core.model.DownloadEngineListener;
...
public class DownloadService extends Service
{
    ...
    public static final String ACTION_SHUTDOWN = "xtrem.download.mobile.service.DownloadService.ACTION_SHUTDOWN";
    public static final String ACTION_RUN_DOWNLOAD = "xtrem.download.mobile.service.ACTION_RUN_DOWNLOAD";
    public static final String ACTION_CHANGE_PARAMS = "xtrem.download.mobile.service.ACTION_CHANGE_PARAMS";
