...
import xtrem.download.mobile.ui.main.MainActivity;
...
import static xtrem.download.mobile.core.model.data.entity.DownloadInfo.VISIBILITY_HIDDEN;
import static xtrem.download.mobile.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE;
import static xtrem.download.mobile.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
import static xtrem.download.mobile.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION;
...
public class DownloadNotifier
{
    ...
    public static final String DEFAULT_NOTIFY_CHAN_ID = "xtrem.download.mobile.DEFAULT_NOTIFY_CHAN";
    public static final String FOREGROUND_NOTIFY_CHAN_ID = "xtrem.download.mobile.FOREGROUND_NOTIFY_CHAN";
    public static final String ACTIVE_DOWNLOADS_NOTIFY_CHAN_ID = "xtrem.download.mobile.CTIVE_DOWNLOADS_NOTIFY_CHAN";
    public static final String PENDING_DOWNLOADS_NOTIFY_CHAN_ID = "xtrem.download.mobile.PENDING_DOWNLOADS_NOTIFY_CHAN";
    public static final String COMPLETED_DOWNLOADS_NOTIFY_CHAN_ID = "xtrem.download.mobile.COMPLETED_DOWNLOADS_NOTIFY_CHAN";
