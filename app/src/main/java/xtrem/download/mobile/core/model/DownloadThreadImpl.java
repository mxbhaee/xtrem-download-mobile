...
import xtrem.download.mobile.core.HttpConnection;
...
import xtrem.download.mobile.core.utils.DownloadUtils;
...
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_BAD_REQUEST;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_CANNOT_RESUME;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_FETCH_METADATA;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_FILE_ERROR;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_HTTP_DATA_ERROR;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_PAUSED;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_RUNNING;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_STOPPED;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_SUCCESS;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_TOO_MANY_REDIRECTS;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_UNHANDLED_HTTP_CODE;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_UNKNOWN_ERROR;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_WAITING_FOR_NETWORK;
import static xtrem.download.mobile.core.model.data.StatusCode.STATUS_WAITING_TO_RETRY;
