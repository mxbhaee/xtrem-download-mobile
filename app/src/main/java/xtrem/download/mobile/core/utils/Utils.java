...
import static xtrem.download.mobile.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static xtrem.download.mobile.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
public class Utils {
    ...
    public static void enableBrowserLauncherIcon(@NonNull Context context, boolean enable) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(context, "xtrem.download.mobile.ui.browser.BrowserIcon"),
    ...
    public static void disableBrowserFromSystem(@NonNull Context context, boolean disable) {
        ...
        int flag = (disable ?
                ...
                PackageManager.COMPONENT_ENABLED_STATE_ENABLED);
        pm.setComponentEnabledSetting(
                new ComponentName(context, "xtrem.download.mobile.ui.browser.Browser"),
                flag, PackageManager.DONT_KILL_APP);
    }
